...
struct ErrorCorrectionConfig {
    ...
    inline static MSDFGEN_PUBLIC const double defaultMinDeviationRatio = 1.111111111111111;
    /// The default value of minImproveRatio.
    inline static MSDFGEN_PUBLIC const double defaultMinImproveRatio = 1.111111111111111;
