...
#define KE_EDITOR_FRIEND            \
	friend class KE_EDITOR::Editor; \
	friend class KE_EDITOR::ImGuiHandler;
...
#define KE_LOG(message, ...)                                               \
	KE_GLOBAL::console.LogMessage("log", __FILE__, __LINE__, __FUNCTION__, \
								  message, __VA_ARGS__)
#define KE_WARNING(message, ...)                                               \
	KE_GLOBAL::console.LogMessage("warning", __FILE__, __LINE__, __FUNCTION__, \
								  message, __VA_ARGS__)
#define KE_ERROR(message, ...)                                               \
	KE_GLOBAL::console.LogMessage("error", __FILE__, __LINE__, __FUNCTION__, \
								  message, __VA_ARGS__)
#define KE_LOG_CHANNEL(channel, message, ...)                                \
	KE_GLOBAL::console.LogMessage(channel, __FILE__, __LINE__, __FUNCTION__, \
								  message, __VA_ARGS__)
...
#define ADD_LAMBDA_WINDOW(name, lambda) \
	KE_EDITOR::editorPreload.lambdaWindows.push_back({name, lambda})
