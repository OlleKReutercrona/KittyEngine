...
namespace KE_EDITOR {
	...
	inline bool EditorMouseInside(ImVec2 pos1, ImVec2 pos2, ImVec2 mousePos) {
		return mousePos.x > pos1.x && mousePos.x < pos2.x &&
			   mousePos.y > pos1.y && mousePos.y < pos2.y;
	}

	inline bool EditorIntersectBox(const KE::Box& aBox, const Rayf& aRay,
								   Vector3f& aOutHitPoint) {
