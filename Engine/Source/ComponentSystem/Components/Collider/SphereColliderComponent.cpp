...
KE::SphereColliderComponent::SphereColliderComponent(GameObject& aGameObject)
	: KE::Component(aGameObject) {}
...
void KE::SphereColliderComponent::OnCollisionEnter(
	const CollisionData& aCollisionData) {}

void KE::SphereColliderComponent::OnCollisionStay(
	const CollisionData& aCollisionData) {}

void KE::SphereColliderComponent::OnCollisionExit(
	const CollisionData& aCollisionData) {}

void KE::SphereColliderComponent::SetData(void* aDataObject) {
	SphereColliderComponentData* data =
		(SphereColliderComponentData*)aDataObject;
	...
	// myCollider->myShape = new Sphere(myRadius,
...
void KE::SphereColliderComponent::DrawDebug(KE::DebugRenderer& aDbg) {
	...
	aDbg.RenderSphere(
		myGameObject.myWorldSpaceTransform.GetPositionRef() + myOffset,
		myRadius, colour);
}
