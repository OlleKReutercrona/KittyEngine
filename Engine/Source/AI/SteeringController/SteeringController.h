...
public:
	...
	inline void SetPathfinder(KE::Pathfinder* aPathfinder) {
		myPathfinder = aPathfinder;
	}
	...
	inline void ClearSteering() {
		mySteeringOutput.linear = {};
		myKinematic.velocity = {};
	}
	inline const Vector3f& GetVelocity() {
		return myKinematic.velocity;
	}
