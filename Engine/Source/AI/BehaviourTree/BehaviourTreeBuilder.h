...
namespace AI {
	...
	inline std::string typeNames[(int)TreeNodeType::COUNT] = {
		"Sequence",		   "Selector",		"FLOW_END",

		"LEAF_START",	   "LEAF_END",

		"DECORATOR_START", "DECORATOR_END",
	};
	...
	private:
		static bool RecursiveAttach(KE::ScriptMemberID& aFromNodeID,
									AI::TreeNode* aTreeNode,
									RecursiveData& aData);
		static TreeNodeType EvaluateEnum(KE::ScriptNode*);

		static KE::ScriptNode* GetEditorRootNode(AI::RecursiveData& aData,
