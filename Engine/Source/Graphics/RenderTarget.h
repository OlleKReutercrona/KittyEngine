...
namespace KE {
	...
	public:
		RenderTarget();
		void SetFormat(DXGI_FORMAT aFormat) {
			myFormat = aFormat;
			Create();
		}
		...
		bool ShouldRenderDebug() const {
			return myShouldRenderDebug;
		}
		void SetShouldRenderDebug(bool aShouldRenderDebug);

		bool ShouldRenderPostProcessing() const {
			return myShouldRenderPostProcessing;
		}
		void SetShouldRenderPostProcessing(bool aShouldRenderPostProcessing) {
			myShouldRenderPostProcessing = aShouldRenderPostProcessing;
		}
