...
namespace KE {
	...
	public:
		...
		void Init(KE::Graphics* aGraphics, unsigned int aParticleCapacity,
		...
		void BurstText(const Transform& aTransform, KE::SpriteFont* aFont,
					   const std::string& aText);

		SharedParticleAttributes& GetSharedAttributes() {
			return mySharedParticleAttributes;
		}

		inline SpriteBatch* GetSpriteBatch() {
