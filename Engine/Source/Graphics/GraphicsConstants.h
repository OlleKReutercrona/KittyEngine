...
#pragma region DeferredPasses
	...
	inline const char* EnumToString(const eDeferredPasses aPass) {
		switch (aPass) {
			case eDeferredPasses::Camera:
				return "Camera";
			case eDeferredPasses::WorldSpace:
				return "WorldSpace";
			case eDeferredPasses::Albedo:
				return "Albedo";
			case eDeferredPasses::Normal:
				return "Normal";
			case eDeferredPasses::Material:
				return "Material";
			case eDeferredPasses::AmbientOcclusionAndCustom:
				return "AmbientOcclusionAndCustom";
			case eDeferredPasses::Depth:
				return "Depth";
			default:
				return "Unknown";
		}
	...
	inline const char* EnumToString(const eBlendStates aState) {
		switch (aState) {
			case eBlendStates::Disabled:
				return "Disabled";
			case eBlendStates::AlphaBlend:
				return "AlphaBlend";
			case eBlendStates::AdditiveBlend:
				return "AdditiveBlend";
			case eBlendStates::TransparencyBlend:
				return "TransparencyBlend";
			case eBlendStates::VFXBlend:
				return "VFXBlend";
			default:
				return "Unknown";
		}
...
#pragma region Depth StencilStates
	...
	inline const char* EnumToString(const eDepthStencilStates aState) {
		switch (aState) {
			case eDepthStencilStates::Write:
				return "Write";
			case eDepthStencilStates::ReadOnlyGreater:
				return "ReadOnlyGreater";
			case eDepthStencilStates::ReadOnlyLess:
				return "ReadOnlyLess";
			case eDepthStencilStates::ReadOnlyEmpty:
				return "ReadOnlyEmpty";
			case eDepthStencilStates::Always:
				return "Always";
			case eDepthStencilStates::ReadOnlyLessEqual:
				return "ReadOnlyLessEqual";
			default:
				return "Unknown";
		}
	}
	...
	inline const char* EnumToString(const eRasterizerStates aState) {
		switch (aState) {
			...
			case eRasterizerStates::NoCulling:
				return "NoCulling";
			case eRasterizerStates::Wireframe:
				return "Wireframe";
			default:
				return "Unknown";
		}
...
#pragma region RenderLayers
	...
	inline const char* EnumToString(const eRenderLayers aLayer) {
		switch (aLayer) {
			case eRenderLayers::Back:
				return "Back";
			case eRenderLayers::Main:
				return "Main";
			case eRenderLayers::Front:
				return "Front";
			case eRenderLayers::UI:
				return "UI";
			default:
				return "Unknown";
		}
