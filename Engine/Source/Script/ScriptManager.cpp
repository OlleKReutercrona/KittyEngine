...
void KE::ScriptManager::LoadScript(const std::string& aName,
								   const std::string& aPath) {
	CreateScript(aName)->LoadFromFile(aPath);
	myScripts[aName]->SetScriptFileInfo(aName, aPath);
}

void KE::ScriptManager::SaveScript(const std::string& aName,
								   const std::string& aPath) {
