...
namespace KE {
	...
	public:
		GUIScene() = default;
		~GUIScene() = default;
		// void	Init(const eGUISceneType aType, const size_t
		...
		GUIElement& CreateGUIElement(const std::string& aName,
		...
		GUIElement& DuplicateGUIElement(const GUIElement& aElement,
										const Vector2f& aResolution);
		GUITooltip& CreateTooltip(GUIElement& aElement, const Vector2f& aSize,
